...
class TransactionController extends AbstractController
{
     ...
     * @return JsonResponse
     */
    public function makeDepot(Request $request,TransactionRepository $repoTransaction, AddUserService $addUserService,EntityManagerInterface $manager, SerializerInterface $serializer): JsonResponse
    {
        //dd();
    ...
    public function makeRetrait(Request $request, EntityManagerInterface $manager, TransactionRepository $repository, ClientRepository $repoClient, SerializerInterface $serializer): JsonResponse
    {
        ...
        if ($clientDepot != $transaction->getClientDepot()){
     ...
     * @return JsonResponse
     */
    public function transactionByCode(Request $request,TransactionRepository $repository, SerializerInterface $serializer): JsonResponse
    {

        $transaction = $repository->findOneBy(["code_transaction"=>$request["code"]]);
        $transactionsOn = $serializer->serialize($transaction,"json",["groups"=>["trans:on"]]);
        //dd($transactions);
        return new JsonResponse($transactionsOn,Response::HTTP_OK,[],true);
    }
