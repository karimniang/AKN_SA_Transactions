...
class User implements UserInterface
{
     ...
     * @groups({"userBuild:read","read:agence:create","agence:read","caissier:read","read:depot:create","depot:read","user:agence:read","trans:on"})
     */
    protected $id;
     ...
     * @groups({"admin_sys:write","userBuild:read","read:agence:create","agence:read","caissier:read","read:depot:create","depot:read","user:agence:read","trans:on"})
     */
    private $firstname;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @groups({"admin_sys:write","userBuild:read","read:agence:create","agence:read","caissier:read","user:agence:read"})
     */
    private $telephone;
