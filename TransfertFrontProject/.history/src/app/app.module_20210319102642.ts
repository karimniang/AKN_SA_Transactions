...
@NgModule({
  declarations: [AppComponent, DepotComponent, RetraitComponent, HeaderTransactionsComponent, CalculFraisComponent, DepotModalComponent, RetraitModalComponent, TransactionCoursComponent],
  entryComponents: [],
