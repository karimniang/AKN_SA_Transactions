...
export class DepotComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private router: Router, private logService: LogServiceService,public modalConreoller:ModalController,public alertController:AlertController) { }
