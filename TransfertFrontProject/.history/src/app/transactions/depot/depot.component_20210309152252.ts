...
export class DepotComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private router: Router, private logService: LogServiceService, private modalConreoller:ModalController, private alertController:AlertController) { }
  ...
  async sendDepot() {
    ...
    //       },
    //     ],
    //     buttons: [{text:'Cancel',cssClass:"light"},{text:'Open Modal',cssClass:"danger"}]
    //   }
    // ).then(res => {
