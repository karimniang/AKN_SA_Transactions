...
export class DepotComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private router: Router, private logService: LogServiceService, private modalConroller:ModalController, private alertController:AlertController) { }
