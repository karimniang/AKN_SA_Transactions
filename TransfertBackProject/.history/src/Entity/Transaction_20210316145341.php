 ...
 *          "route_name"="cancel_depot"
 *      },
 *      "post_reload"={
 *          "method"="POST",
 *          "path"="/transactions/reload",
 *          "route_name"="reload_depot"
 *      },
 ...
 *          "normalization_context"={"groups"={"trans:on"}}
 *      },
 *      "get_transactions_code"={
 *          "method"="GET",
 *          "path"="/transactions/bycode/{code}",
...
class Transaction
{
     ...
     * @Groups({"trans:code","trans:on","part:tiers"})
     */
    private $id;

    /**
     * @ORM\Column(type="integer")
     * @Groups({"trans:code","transaction:done","transaction:retrait","trans:on","part:tiers"})
     ...
     * @Groups({"trans:code","transaction:done","transaction:retrait","trans:on"})
     */
    private $date_depot;
